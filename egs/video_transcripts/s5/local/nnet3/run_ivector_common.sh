...
if [ $stage -le 3 ]; then
  ...
  for datadir in ${train_set}_sp libri_test_clean libri_test_other libri_dev_clean\
          libri_dev_other ted_test ted_dev; do
...
if [ $stage -le 10 ]; then
  ...
  for data in libri_test_clean libri_test_other libri_dev_clean libri_dev_other\
          ted_test ted_dev; do
